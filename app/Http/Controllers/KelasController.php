...
class KelasController extends Controller
{
    ...
    public function aksi_tambah_kelas(Request $request)
    {
        ...
        return redirect()->route('kelas.index')->with('tambah', 'Data berhasil ditambahkan');
    }
    ...
    public function aksiedit(Request $request, $id)
    {
        ...
        return redirect()->route('kelas.index')->with('edit', 'Data berhasil di edit');
    }
    ...
    return redirect()->route('kelas.index')->with('hapus', 'Data berhasil dihapus');
    }
